...
import CreateOfferTab1 from "../../../components/Create-offer-Tabs/Tab1";
import CreateOfferTab2 from "../../../components/Create-offer-Tabs/Tab2";
import CreateOfferTab3 from "../../../components/Create-offer-Tabs/Tab3";
...
const CreateOffer = () => {
  ...
  return (
    <div className="main-create-offer">
      ...
      <form className="offer-form">
        ...
        {/* rich text start */}
        <div className="richText-importFile">
          ...
          <div className="import-file">
            <label className="quill-label">Offer Icon (Optional)</label>
            <div className="main-import">
              <FaFileMedical className="add-file-icon" />
              <p className="file-content">
                Click to upload{" "}
                <span className="content-span">or drag & drop</span>{" "}
              </p>
        ...
        <div className="main-offer-settings">
          ...
          <div className="last-btn">
            <button className="update-btn">
              <span className="btn-text">Update Offer</span>
            </button>
          </div>
        </div>
        {/* offers settings end */}
