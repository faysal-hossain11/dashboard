...
import CallbackManagerModal from "./CallbackManagerModal";
...
const CallbackManager = () => {
  ...
  return (
    <div>
      ...
      <div className="p-5 max-[576px]:p-2 mt-[60px] rounded-[10px] bg-white max-[767px]:mt-5">
        <div className="sm:flex justify-between items-center max-[767px]:flex-col max-[767px]:gap-5">
